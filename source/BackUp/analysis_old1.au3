...
global $compatible_DC
global $window_rect

func get_actual_bitmap()
	$device_context = _WinAPI_GetDC($hWnd)
	$compatible_DC  = _WinAPI_CreateCompatibleDC($hDC)
	$window_rect    = _WinAPI_GetWindowRect($hWnd)
endfunc
